...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio and resume site for Nathan Iles: bio, photography, projects, and writing.",
  icons: {
    icon: "/favicon.ico",
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${spaceGrotesk.className} ${geistMono.variable} antialiased min-h-screen bg-background text-foreground`}
      >
        ...
        <main className="px-2 sm:px-3 md:px-4 lg:px-6 py-10">{children}</main>
